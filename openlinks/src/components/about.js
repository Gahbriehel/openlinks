      ...
      <div className='about_section3'>
        <div className='content'>
          <div className='content_text'>
            ...
            <p>We don't stop at laptops. Complete your tech setup with accessories like mice, keyboards, headphones, and external storage. Looking for inspiration? Browse our curated collections to find the best devices for productivity, entertainment, and more.</p>
          </div>
          <div className='content_image'>
            <img src='/images/laptop23.jpeg' alt='laptops'></img>
          </div>
        </div>
        <div className='content'>
          <div className='content_image'>
            <img src='/images/laptop16.jpeg' alt='laptop'></img>
          </div>
          <div className='content_text'>
